...
listings_joined <- left_join(listings_summary,listings_cleansed[,c('id','months','rules_length','security_deposit','instant_bookable','property_type')])
...
# reviews_per_month is always NA when number of reviews is 0, but we actually want to use 0 as the rate
listings_summary[is.na(listings_summary$reviews_per_month),'reviews_per_month'] <- 0
